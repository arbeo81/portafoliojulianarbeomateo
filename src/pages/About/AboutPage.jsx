            ...
            <div className="skill-container">
              ...
              <div className="skill-card" data-aos="flip-down" data-aos-delay="300">
                ...
                <p className="skill-info">
                  <FormattedMessage
                    id='about-skills-5'
                    defaultMessage='A year using this framework, even so, I used it in countless work projects, which allowed me to get to know it for the most part.'
                  />
                </p>
              </div>
              <div className="skill-card" data-aos="flip-right" data-aos-delay="300">
